...
import { addToWishlist } from '../redux/slices1/wishlistSlice1';
  ...
  return (
    ...
    <Row className='m-5' style={{marginTop:"150px"}}>
      ...
      <Card.Body>
        ...
        <Button onClick={()=>dispatch(addToCart (item))} variant="outline-primary"><i class="fa-solid fa-cart-plus"></i></Button>
        </div>
